...
| **DevinX Connector for macOS**   | `0.1.6`             | [Signed and notarized Apple-silicon release](https://github.com/fenner888/Devinx/releases/latest) |
...
3. Install Build `0.1.0 (79)` and complete the in-app onboarding.
...
- The initial mobile release is iPhone-only. Android and iPad are not supported. Connector `0.1.6`
