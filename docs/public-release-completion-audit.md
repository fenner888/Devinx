...
| Production build/export and artifact integrity | Verified for Build 25 | Build 25 signature, metadata, entitlements, update channel/runtime, `NSFileProtectionComplete`, privacy manifests, absence of reporting/notification artifacts, and internal upload passed; repeat only if candidate code changes |
