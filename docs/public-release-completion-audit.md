...
| Privacy disclosures and manifests | Implemented; human publication required | `PRIVACY.md`, in-app Privacy, `docs/app-privacy-review.md`, final IPA manifest inspection; App Store answers and stable public policy URL remain unpublished |
