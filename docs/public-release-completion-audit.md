...
| Production build/export and artifact integrity | Verified for Build 23; superseded by current changes | Build 23 signature/IPA/privacy inspection passed; a new final binary must repeat every artifact check |
