...
| Companion, floating composers, and local history | Implemented; physical required | Build 50 includes correction `d90fbb7`, which makes Cloud and Computer composers measured translucent overlays with dynamic history clearance; component/timeline tests and prior steering evidence pass, while physical Build 50 testing must prove visible content behind the surface, full final-line clearance, history boundaries, smooth travel, and reduced motion |
...
| Production build/export and artifact integrity | Verified artifact for Build 50 | Build 50 signature, metadata, entitlements, production update channel/runtime, `NSFileProtectionComplete`, exempt-encryption declaration, exact microphone disclosure, 10 privacy manifests, `get-task-allow=false`, and absence of APS entitlement passed; SHA-256 `59b658906a35182d88f7fa11a03f08e75dedc87edcae43ef7eee46dc5a04d3d5`; EAS submission `d48480a2-af66-4625-b5dd-c3512a17b20c` finished successfully and was submitted to Apple for internal TestFlight |
