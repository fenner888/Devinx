...
| Production build/export and artifact integrity | Verified artifact for Build 28 | Build 28 signature, metadata, entitlements, update channel/runtime, `NSFileProtectionComplete`, 10 privacy manifests, and absence of reporting/notification artifacts passed; App Store upload status is recorded separately in `docs/release-readiness.md` |
