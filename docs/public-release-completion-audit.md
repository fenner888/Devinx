...
| Companion, floating composers, and local history | Implemented; physical required | Post-Build-49 correction `d90fbb7` makes Cloud and Computer composers measured translucent overlays with dynamic history clearance; component/timeline tests and prior steering evidence pass, while the next physical candidate must prove visible content behind the surface, full final-line clearance, history boundaries, smooth travel, and reduced motion |
...
| Production build/export and artifact integrity | Verified artifact for Build 49 | Build 49 signature, metadata, entitlements, production update channel/runtime, `NSFileProtectionComplete`, exempt-encryption declaration, exact microphone disclosure, 10 privacy manifests, `get-task-allow=false`, and absence of APS entitlement passed; SHA-256 `018d946db1ec5415c0770f80e128f24d4c29575f167870ba396cddf9b7c5adf2`; Apple accepted internal submission `a7a4b438-860a-4048-88b2-ad7dc15dd2c8` |
