...
| Production build/export and artifact integrity | Verified for Build 27 | Build 27 signature, metadata, entitlements, update channel/runtime, `NSFileProtectionComplete`, 10 privacy manifests, absence of reporting/notification artifacts, and internal upload passed |
